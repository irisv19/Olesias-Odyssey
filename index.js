const story = {
  ...
  example105: {
    text: "She decides to go toward the shed to see if there are any tools in there. She takes the lock off and opens the door and sees theres some stuff in there. There's a book shelf full of books and bottles covered in dust. It looked like no one has been in there in a while. The shed is a lot bigger on the inside than it does from outside. What should she do now?",
    choices: [
